...
const CashierOrderPage = () => {
  ...
  const { cashier, cart } = useSelector(
    (state: any) => ({
        ...
        <>
          <div className="relative w-full px-1 lg:px-6 py-4">
            <div className="lg:flex flex-row w-full justify-between">
              ...
              <div
                className={`w-full lg:w-fit flex flex-row justify-between gap-y-2 lg:gap-y-0 
              ...
              >
                ...
                <div
                  className={`w-fit h-fit rounded-2xl  border border-[#06C167] p-3 cursor-pointer ${
              ...
              {chef?.menu && chef?.menu?.length > 0 ? (
                <>
                  <div className="inline-flex flex-col lg:flex-row w-full justify-between items-center gap-y-3">
                    ...
                    <button
                      className="w-full lg:w-fit primary_bg_color text-white font-semibold text-lg py-2 px-10 rounded-lg flex flex-row items-center justify-center gap-x-5"
                      onClick={() => setCartModal(true)}
                    >
                      Proceed
                  ...
                  {/* CATEGORIES */}
                  {chef?.menuCategories && chef?.menuCategories?.length > 0 && (
                ...
                <div className="flex flex-col items-center">
                  <h2 className="text-xl input_text mb-3">No meals here.</h2>
