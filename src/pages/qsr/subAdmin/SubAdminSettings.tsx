...
import {
  ...
  changePasswordQsrSubAdminAccount,
  changePasswordSubChefAccount,
  updateProfileChefAccount,
  updateProfileQsrSubAdminAccount,
...
const QsrSubAdminSettings = () => {
  ...
  const { handleChange, handleSubmit, values } = useFormik({
    ...
    onSubmit: () => {
      dispatch(updateProfileQsrSubAdminAccount(values, closeProfileModal));
    },
  });
...
export default QsrSubAdminSettings;
