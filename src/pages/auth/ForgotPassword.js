      ...
      <main className="w-full h-full flex flex-row items-center justify-center">
        <div className="bg-white rounded-3xl h-3/4 min-h-1/2 w-11/12 lg:w-1/3 mx-auto lg:flex flex-col items-center justify-start">
            <div className="h-full flex flex-col items-center justify-start relative py-5 px-3 lg:px-8">
                <p className='text-center font_bold text-xl mb-5'>Forgot Password</p>
                <p className='text-center font_regular text-sm mb-5'>Enter your email to you reset your password. If it is valid, we will send a verification and instructions by email.</p>
                <Formik
                    initialValues={{
                        email: "",
                    }}
                ...
                >
                    ...
                    <Form onSubmit={props.handleSubmit} className='h-full w-full flex flex-col justify-between gap-y-2'>
                        ...
                        <div className="w-full">
                            ...
                            <div className="w-full">
                                <Link to={'/auth/login'}>
                                    <p className="text-xs font_regular hover:underline font-semibold"><span className="text-[#747372]">Already registered? </span><span className="text-[#4A443A]"></span>Log In</p>
                                </Link>
                            </div>
                        </div>
