                    ...
                    <Form onSubmit={props.handleSubmit} className='flex flex-col gap-y-2'>
                        ...
                        <div className="w-full">
                            <Link to={'/auth/forgot-password'}>
                                <p className="text-xs font_regular hover:underline font-semibold"><span className="text-[#747372]">Forgot Password? </span><span className="text-[#4A443A]"></span>Reset</p>
                            </Link>
                        </div>
