  ...
  useEffect(() => {
    ...
    axios
      ...
      .then(({ data }) => {
        ...
        console.log('numOfRestaurants= ', data.data.filter((item :any, i :any) => item.profile.isRestaurant === true))
                  ...
                  >
                    ...
                    {restaurants?.map((restaurant: any, i: number) => (
                      <div
                        ...
                        key={i}
                        onClick={() => {
                          setCurrentRestaurant(restaurant.business.businessName);
                          setOpenRestaurantOptions(false);
                        }}
                      >
                        <div
                          className={`w-2 lg:w-4 h-2 lg:h-4 rounded-full mr-2 lg:mr-3 ${
                            currentRestaurant === restaurant.business.businessName
                              ? "primary_bg_color"
                              : "bg_gray_color"
                          }`}
                        />
