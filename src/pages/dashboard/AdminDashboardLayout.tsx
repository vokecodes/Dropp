...
import { ADMIN_ROUTES, CHEF_ROUTES, SUB_CHEF_ROUTES } from "../../routes/routes";
...
const AdminDashboardLayout = ({children }) => {
    ...
    const menuItems = [
        ...
        icon: (
            <svg width="24" height="24" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M9.99667 20.3333C9.74333 20.3333 9.49 20.2399 9.29 20.0399C8.90333 19.6533 8.90333 19.0133 9.29 18.6266L13.5567 14.3599C13.77 14.1466 14.05 14.0399 14.3567 14.0666C14.65 14.0933 14.9167 14.2533 15.09 14.5066L16.5433 16.6933L21.2767 11.9599C21.6633 11.5733 22.3033 11.5733 22.69 11.9599C23.0767 12.3466 23.0767 12.9866 22.69 13.3733L17.09 18.9733C16.8767 19.1866 16.5967 19.2933 16.29 19.2666C15.9967 19.2399 15.73 19.0799 15.5567 18.8266L14.1033 16.6399L10.7033 20.0399C10.5033 20.2399 10.25 20.3333 9.99667 20.3333Z" fill={"#787878"}/>
                <path d="M21.9948 16.3332C21.4481 16.3332 20.9948 15.8798 20.9948 15.3332V13.6665H19.3281C18.7815 13.6665 18.3281 13.2132 18.3281 12.6665C18.3281 12.1198 18.7815 11.6665 19.3281 11.6665H21.9948C22.5415 11.6665 22.9948 12.1198 22.9948 12.6665V15.3332C22.9948 15.8798 22.5415 16.3332 21.9948 16.3332Z" fill={"#787878"}/>
                <path d="M19.9974 30.3332H11.9974C4.7574 30.3332 1.66406 27.2398 1.66406 19.9998V11.9998C1.66406 4.75984 4.7574 1.6665 11.9974 1.6665H19.9974C27.2374 1.6665 30.3307 4.75984 30.3307 11.9998V19.9998C30.3307 27.2398 27.2374 30.3332 19.9974 30.3332ZM11.9974 3.6665C5.85073 3.6665 3.66406 5.85317 3.66406 11.9998V19.9998C3.66406 26.1465 5.85073 28.3332 11.9974 28.3332H19.9974C26.1441 28.3332 28.3307 26.1465 28.3307 19.9998V11.9998C28.3307 5.85317 26.1441 3.6665 19.9974 3.6665H11.9974Z" fill={"#787878"}/>
            </svg>
        ),
        title: (<span>Homemade <br /> (Coming soon!)</span>),
