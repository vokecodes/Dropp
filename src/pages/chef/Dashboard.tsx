...
const ChefDashboard = () => {
  ...
  const checkItems = [
    ...
    },
    {
      ...
      checked: user?.uploadDocuments,
      // type: { uploadDocuments: true },
      to: "https://forms.gle/pdU7KGqDPPVfwAVx8",
      external: true,
    },
    {
      title: "Food safety test",
      checked: user?.foodSafety,
      // type: { foodSafety: true },
      to: "https://forms.gle/QkcZQ6tvEXAkxpDy7",
      external: true,
    },
    {
      title: "Virtual kitchen visit",
      checked: user?.virtualKitchenVisit,
      // type: { virtualKitchenVisit: true },
      to: "https://calendly.com/tryhomemade/15mins",
      external: true,
    },
  ];
