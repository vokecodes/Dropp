      ...
      <div className="w-11/12 lg:w-3/4 mx-auto mt-10 mb-20 p-0">
        ...
        <div className="mb-5 mx-0">
          <p className="mt-2 font-bold text-black text-base font_regular">
            ...
            (1) YOU WILL ONLY BE PERMITTED TO PURSUE CLAIMS AGAINST HOMEMADE ON AN INDIVIDUAL BASIS, NOT AS A PLAINTIFF OR CLASS MEMBER IN ANY CLASS OR REPRESENTATIVE ACTION OR PROCEEDING,
        ...
        <div className="mb-5 mx-0">
          <p className="text-black text-2xl font_bold">
            Homemade offers a marketplace
          </p>

          <p className="mt-2 font-normal text-black text-base font_regular">
            It is not itself a Seller and is not preparing, packaging, or selling any food. The Service includes enabling users to connect with each other and related services, but we are not a party to any purchase or sales transaction. To encourage return use of the Service, Homemade may also help facilitate the resolution of disputes between Customers and Sellers, but Homemade has no control over and does not guarantee (a) the existence, quality, safety, authenticity, or legality of Meals offered or sold on the Service; (b) the truth or accuracy of a Seller's content or listings on the Service; (c) the ability of a Seller to sell Meals through the Service and deliver Meals within required delivery windows; (d) the ability of Customers to pay for Meals purchased through the Service; or (e) that a Customer or Seller will actually complete a transaction, effectuate trouble-free delivery and shipping, or return a Meal through the Service. 
          </p>
          
          <p className="font-normal text-black text-base font_regular">
            Sellers are independent business owners and independent contractors to Customers and not employees, partners, representatives, agents, joint venturers, or franchisees of Homemade. Homemade does not cook, package or deliver food and does not employ people to cook, package or deliver food. 
          </p>
          
          <p className="font-normal text-black text-base font_regular">
            Each Seller is solely responsible for complying with all applicable laws, rules and regulations and standards, including but not limited to those pertaining to the preparation, sale, marketing, packaging, handling, and delivery of all Meals ordered through Homemade, and updating details and prices relating to the Meals offered. Each Seller is solely liable for the quality, safety, and freshness of its products, and Homemade does not verify the credentials, representations, products, services, or prices offered by any Sellers, and does not guarantee the quality of the product or services, or that Sellers or Meals comply with applicable laws. Homemade will not be liable or responsible for any Meals provided by Sellers that are a cause of injury or that do not meet your expectations in any manner. 
          </p>
          
          <p className="font-normal text-black text-base font_regular">
            Depending on the region/location, Homemade may enter into agreements with third party independent contractors (each a "Delivery Company") to provide delivery services under certain circumstances if desirable by individual Sellers or Customers. If a Seller or Customer chooses to use a Delivery Partner to deliver a Meal, Homemade is not offering such delivery services and has no responsibility or liability for the actions or inactions of any Delivery Partner. Homemade will not be liable or responsible for any delivery services provided by a Delivery Partners or any errors or misrepresentations made by them. Delivery Partners are required to comply with all applicable laws, rules and regulations.
          </p>
        </div>
        ...
        <div className="mb-5 mx-0">
          ...
          <p className="mt-2 font-normal text-black text-base font_regular">
            You may be required to register with Homemade in order to access and use certain features of the Service. If you choose to register for the Service, you agree to provide and maintain true, accurate, current and complete information about yourself as prompted by the Service's registration form. Registration data and certain other information about you are governed by our Privacy Policy. The Service is available only to individuals who can form legally binding contracts under applicable law. Without limiting the foregoing, the Service is not available to minors (people under the age of 18 in their state or province of residence) or to temporarily or permanently suspended users of the Service (both Customers and Sellers). If you do not qualify, please do not use the Service. Additionally, Homemade reserves the right to refuse access to, or use of the Service to, anyone who breaches these Terms of Service or for the reasons related to the safety of the Homemade Community including Homemade Users, employees, or prospective Users. Except as expressly authorized otherwise by Homemade, you are only authorized to create and use one account for the Service and are prohibited from using alter egos or other disguised identities when using the Service. You are responsible for maintaining the confidentiality of your password and account, if any, and are fully responsible for any and all activities that occur under your password or account. You agree to (a) immediately notify Homemade of any unauthorized use of your password or account or any other breach of security, and (b) ensure that you exit from your account at the end of each session when accessing the Service. Homemade will not be liable for any loss or damage arising from your failure to comply with this Section. 
          </p>

          <p>
            Homemade reserves the right to modify or discontinue, temporarily or permanently, the Service (or any part thereof) with or without notice. You agree that Homemade shall not be liable to you or to any third party for any modification, suspension or discontinuance of the Service. You acknowledge that Homemade may establish general practices and limits concerning use of the Service. You agree that Homemade has no responsibility or liability for the deletion or failure to store any data or other content maintained or transmitted by the Service. You acknowledge that Homemade reserves the right to terminate accounts that are inactive for an extended period of time. You further acknowledge that Homemade reserves the right to change these general practices and limits at any time, in its sole discretion, with or without notice. 
          </p>
          
          <p>
            The Service may include certain services that are available via a mobile device, including (i) the ability to upload content (including Meal options or Seller or Customer information) to the Service via a mobile device, (ii) the ability to browse the Service and the Site from a mobile device and (iii) the ability to access certain features through an application downloaded and installed on a mobile device (collectively, the "Mobile Services"). To the extent you access the Service through a mobile device, your wireless service carrier's standard charges, data rates and other fees may apply. In addition, downloading, installing, or using certain Mobile Services may be prohibited or restricted by your carrier, and not all Mobile Services may work with all carriers or devices. In the event you change or deactivate your mobile telephone number, you agree to promptly update your Shef account information to ensure that your messages are not sent to the person that acquires your old number. You acknowledge and agree that your use of the Service must be in accordance with the usage rules established by your mobile device platform or service provider. By registering for and using the Service, including the Mobile Services, and providing your contact information, you are consenting to be contacted by Shef for marketing and/ or transactional purposes by telephone, text message (which may be automated), email, fax, or other means. By using the Mobile Services, you also agree that Homemade may communicate with you by any electronic means to your mobile device and that certain information about your usage of the Mobile Services may be communicated to us. In the event you no longer want to receive communications from Homemade, you agree to notify Homemade directly. You may opt-out of text messages by texting STOP in response to any text message you receive from us and for calls, you may instruct the caller that you are opting out during any call you receive from us. You may also adjust your notification settings on the Notification page in your account settings. If you unsubscribe from our marketing lists, you will no longer receive marketing communications, but we may still contact you (including by text message) regarding management of your account, other administrative matters and to respond to your requests.
          </p>
        </div>
        ...
        <div className="mb-5 mx-0">
          ...
          <p className="mt-2 font-normal text-black text-base font_regular">
            Homemade maintains insurance for its own business operations, but it does not maintain insurance for the actions of Sellers or Customers. If you are a Seller, Homemade recommends that you obtain appropriate insurance to cover the operation of your food facility and the preparation and delivery of Meals. Please review any respective insurance policy carefully, and in particular make sure that you are familiar with and understand any exclusions to, and any deductibles that may apply for, such insurance policy, including, but not limited to, whether or not your insurance policy will cover the actions or inactions of Customers or any third-party service.
          </p>
        </div>
