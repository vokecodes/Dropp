...
import { CHEF_FORGOT_PASSWORD_URL } from "../../_redux/urls";
    ...
    onSubmit: () => {
      dispatch(
        forgotResetPasswordUserAccount(
          CHEF_FORGOT_PASSWORD_URL,
          values,
          AUTH_ROUTES.linkChefResetPassword,
          navigate
        )
      );
    },
      ...
      <div className="lg:mx-20 py-5">
        <div className="lg:flex">
          <div className="lg:w-1/2">
            <img src="/images/chef-auth.png" alt="banner" className="w-full" />
          </div>
          <div className="lg:w-1/2 lg:ml-14 my-5">
            <div className="lg:w-3/4">
              ...
              <p className="mt-5 mb-3 text-lg text-black font_bold">
                Registered?{" "}
                <Link to={AUTH_ROUTES.linkChefLogin}>
                  {" "}
...
export default ChefForgotPassword;
