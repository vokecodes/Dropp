...
import {
  ...
  deleteTables,
  getTables,
  subChefAddSuperTables,
  subChefAddTables,
  subChefDeleteSuperTables,
  subChefDeleteTables,
  subChefGetTables,
  subChefUpdateSuperTables,
  subChefUpdateTables,
  updateSuperWaiter,
  updateTables,
...
const TableManagement = () => {
    ...
    onSubmit: async () => {
      ...
      if (!superWaiter) {
        ...
        if (editSuperWaiter) {
          ...
          await dispatch(
            subChefAddSuperTables(values, closeSuperWaiterModal, resetForm)
          );
        }
  ...
  const deleteSuper = async (tableId) => {
    setSelectedLoading(tableId);
    await dispatch(subChefDeleteSuperTables(tableId));
    setTimeout(() => {
      setSelectedLoading();
    }, 1200);
  };
      ...
      <ChefDashboardLayout>
        <>
          <div className="w-full px-6 py-4">
            ...
            <div className="bg-white rounded-2xl w-full py-6 px-5 mt-3">
              <div className="flex flex-col items-center justify-start gap-y-4">
                <div className="w-full h-full">
                  <div className="lg:w-4/5 bg-white rounded-3xl">
