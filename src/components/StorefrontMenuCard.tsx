    ...
    <div className="w-full h-full">
      <div className="relative w-full h-64 bg-white shadow lg:mt-0 p-2 rounded-xl cursor-pointer flex flex-col justify-between items-stretch">
            ...
            >
              {menu?.images?.map((image: string, i: number) => (
                <img
                  ...
                  src={image}
                  alt="food"
                  className="w-full h-full rounded-s-xl object-cover object-center"
                />
              ))}
            </Carousel>
          )}
        ...
        <div className="w-full h-1/2 flex flex-col items-start justify-between">
          <div className="w-full h-full flex flex-col items-start justify-start lg:justify-between">
            <div className="absolute top-4 left-3 lg:left-4 flex flex-col lg:flex-row justify-start items-center gap-x-2 gap-y-1 lg:gap-y-0">
              {popular && (
                <button className="w-16 h-6 py-1 bg-[#99C446] shadow-sm rounded-3xl flex items-center justify-center">
                  <p className="text-[0.5rem] text-uppercase font_medium text-white text-center">
                    POPULAR
                  </p>
                </button>
              )}
              ...
              {menu?.discount && (
                <div className="yellow_bg w-16 h-6 rounded-3xl flex items-center justify-center">
                  <p className="text-[0.5rem] text-black font_medium text-center">
                    {menu?.discount}% off
                  </p>
                </div>
              )}
            ...
            <h6
              className="text-sm font_bold primary_txt_color mt-1"
              onClick={openMenuInfoModal}
            >
              <span
                className={`${
            ...
            <h3
              className="underline text-gray-400 text-xs font_bold mt-1"
              onClick={openMenuInfoModal}
            >
              See more
            </h3>
            ...
            <div className="my-2 w-full">
              {inCart ? (
                <div className="primary_bg_color flex flex-row justify-between items-center rounded-full p-1 w-full">
                  <p
                    className="font-bold cursor-pointer h-6 w-6 bg-white text-sm rounded-full flex items-center justify-center"
                    onClick={() =>
                      handleDecrement(
                  ...
                  <p className="mx-5 font_bold text-white text-sm">
                ...
                <button
                  className="w-full py-1 border-2 primary_border_color text-sm font_medium text-gray-400 text-center shadow-sm cursor-pointer rounded-full"
...
export default StorefrontMenuCard;
