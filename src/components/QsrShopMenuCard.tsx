...
const QsrShopMenuCard = ({
  ...
  return (
    <div className="w-full h-full">
      <div className="relative w-full h-full bg-white shadow lg:mt-0 p-2 lg:p-0 rounded-xl cursor-pointer flex flex-row justify-between items-stretch">
        <div
          className="w-1/3 h-full grow overflow-hidden mr-5 lg:m-0 qsr-shop"
        ...
        <div className="w-2/3 h-full flex flex-col items-start justify-between lg:p-3">
            ...
            <div className="absolute top-4 left-3 lg:left-4 flex flex-col lg:flex-row justify-start items-center gap-x-2 gap-y-1 lg:gap-y-0">
              {popular && (
                <button className="w-16 h-6 py-1 bg-[#99C446] shadow-sm rounded-3xl flex items-center justify-center">
                  <p className="text-[0.7rem] text-uppercase font_medium text-white text-center">
                    POPULAR
                  </p>
                </button>
              )}
              ...
              {menu?.discount && (
                <div className="yellow_bg w-16 h-6 rounded-3xl flex items-center justify-center">
                  <p className="text-[0.7rem] text-black font_medium text-center">
                    {menu?.discount}% off
                  </p>
                </div>
              )}
...
export default QsrShopMenuCard;
