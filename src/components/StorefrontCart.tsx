...
import {
  QsrCheckoutValues,
  RestaurantCheckoutValues,
  StorefrontDeliveryValues,
  StorefrontPickupValues,
} from "../utils/FormInitialValue";
import {
  QsrCheckoutSchema,
  RestaurantCheckoutSchema,
  StorefrontDeliverySchema,
  StorefrontPickupSchema,
            ...
            {cartMenu.length > 0 ? (
              <>
                ...
                <div className="w-full flex flex-row items-center justify-start gap-x-5 py-5 mx-2 my-5 border-y-2 border-neutral-300">
                  <div
                    className={`size-24 flex flex-col items-center justify-center rounded-xl shadow-xl text-[#8E8E8E] border-2 hover:bg-neutral-200/10 cursor-pointer ${
                      deliveryOption === DELIVERY_OPTIONS[0] &&
                      "border-[#06C167]"
                    }`}
                    onClick={() => setDeliveryOption(DELIVERY_OPTIONS[0])}
                  >
                  ...
                  <div
                    ...
                    onClick={() => setDeliveryOption(DELIVERY_OPTIONS[1])}
                  >
