      ...
      <main className="w-4/5 lg:w-4/6 mx-auto pt-5 pb-20 lg:flex flex-row">
        <div className="flex-1 lg:mt-20 lg:mr-10">
          ...
          <p className="lg:hidden my-7 font_regular text_black1 text-lg text-center">
            We deliver groceries including fresh fruits & vegetables in quality
            directly to your home in 1hr & at supermarket prices.
          </p>
